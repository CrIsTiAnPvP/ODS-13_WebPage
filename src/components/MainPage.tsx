	...
	<>
		<div className='flex flex-col items-center justify-center'>
			<div className='w-2/3 relative h-full'>
				<div className='mt-5 w-full grid  grid-cols-3 grid-rows-none justify-center items-start gap-x-2 h-max gap-y-4 mb-5'>
					<SpotlightCard className="custom-spotlight-card z-10 col-start-1" spotlightColor="rgba(72, 118, 59, 0.5)">
					...
					<SpotlightCard className="custom-spotlight-card z-10 col-start-2" spotlightColor="rgba(72, 118, 59, 0.5)">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white" className="size-8 mb-2">
					...
					<SpotlightCard className="custom-spotlight-card z-10 col-start-3" spotlightColor="rgba(72, 118, 59, 0.5)">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="white" className="size-8 mb-2">
